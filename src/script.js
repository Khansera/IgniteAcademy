...
li.forEach((ele,index)=>{
  ...
  ele.addEventListener('mouseover',()=>{
    console.log(displayPropertyValue)
    if(window.scrollY>0){
...
const logo=document.querySelectorAll('.navItem strong')[0];
const hamburgerIcon=this.document.querySelector('.hamburger i')
const Navlinks=document.querySelectorAll('.navItem')[1];
const hamburger=document.querySelector('.hamburger');
const close=document.querySelector('.close')
const closeLogo=document.querySelector('.close i')
window.addEventListener('scroll', function() {
  if (window.scrollY > 0) {
    ...
    closeLogo.style.color='black';
    li.forEach((ele,index)=>{
      ele.style.color='black'
    })
  } else {
    navbar.style.background='none';
    Navlinks.style.background='#9b4dca';
    hamburgerIcon.style.color='white';
    logo.style.color='white';
    closeLogo.style.color='white';
    li.forEach((ele,index)=>{
